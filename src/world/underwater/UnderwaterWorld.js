...
// //     this.systems = [
// //       new SandFloor(config, quality, sunDir),
// //       new Rocks(config, quality, sunDir, rng),
// //       new Kelp(config, quality, rng),
// //       new FishSchool(config, quality, rng),
// //       new GodRays(config, quality, sunDir, rng),
// //     ];
// //     for (const s of this.systems) this.group.add(s.mesh);
...
// //    * every underwater material and starves the god rays — driven by App in
// //    * lockstep with the descent rush and the sky dome's depth uniform.
// //    */
...
// //       if (u.uIntensity) u.uIntensity.value = 1.0 - t * 0.4; // god rays fade with depth
// //     }
// //   }

// //   update(time, cameraPos, pointerWorld) {
// //     if (!this.group.visible) return;
// //     for (const s of this.systems) s.update(time, cameraPos, pointerWorld);
...
// import { ParticleField } from './ParticleField.js';
// import { GodRays } from './GodRays.js';
// import { TurtleSchool } from './TurtleSchool.js';
...
//       new Kelp(config, quality, rng),
//       new FishSchool(config, quality, rng),
//       new TurtleSchool(config, quality, rng),
//       new GodRays(config, quality, sunDir, rng),
//     ];
//     for (const s of this.systems) this.group.add(s.mesh);
...
//     const density = fogBase + (fogDeep - fogBase) * t;
//     for (const s of this.systems) {
//       // Most systems expose one `.material`; FishSchool now internally runs
//       // two shaders (fish + sharks) and exposes `.materials` instead — this
